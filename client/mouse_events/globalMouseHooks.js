 ...
 * cross-platform approach. For production, consider using native modules
 * like 'iohook' or 'robotjs' for true global hooks.
 */
...
class GlobalMouseHooks extends EventEmitter {
  constructor(options = {}) {
    super();
    ...
    // Native hook module reference (optional)
   ...
   */
  ioHookButtonToStandard(button) {
    // iohook: 1=left, 2=right, 3=middle
    const mapping = { 1: 0, 2: 2, 3: 1 };
  ...
  initRobotJs(robot) {
    ...
    // but we can get mouse button state
    this.startPolling();
  }
   ...
   */
  waitForEnterBbox(bbox, timeout = 30000) {
...
module.exports = GlobalMouseHooks;
